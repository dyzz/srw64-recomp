...
from native_model_hook_patches import PATCHES as NATIVE_MODEL_PATCHES
...
''' + old_cmake + '''
    ...
    report = {"schema": "srw64.recomp-graphics-source-patches.v1", "rt64_commit": revision,
              ...
              "native_model_hooks_sha256": hashlib.sha256((ROOT/'tools/recomp/native_model_hook_patches.py').read_bytes()).hexdigest(),
