...
def main() -> int:
    ...
    subprocess.run([
        ...
        "-I" + str(ROOT / "tools/recomp/probes"), "-I" + str(work / "generated"),
        str(work / "generated/funcs_0.c"), str(ROOT / "tools/recomp/probes/lz_probe.c"),
        "-o", str(binary),
    ], cwd=ROOT, check=True)
    ...
    report: dict = {
        ...
        "bindings_sha256": digest(ROOT / "tools/recomp/probes/lz_probe.c"),
