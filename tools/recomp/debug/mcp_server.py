...
TOOLS = [
    ...
    {"name": "srw64_wait", "description": "Wait until conditions hold: vi (at least), dialogue_active, intro_active, name_page, title_major (3 = main menu), text (in the active dialogue), event {log, kind, count}.",
