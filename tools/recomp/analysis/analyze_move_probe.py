...
from recomp.analysis.analyze_script_trace import ROOT, analyze, digest
...
def main():
    ...
    report = compare(args.baseline.resolve(), args.changed.resolve(), ROOT / 'assets/original-data')
