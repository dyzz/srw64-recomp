...
from recomp.model5600.build_model_5600_rom import ROOT, ResourceTable, build_resource
from recomp.model5600.prepare_model_5600_highpoly import make_mesh
from recomp.model5600.watch_model_5600_runtime import inspect
...
def main() -> None:
    ...
    mesh_path = ROOT/'assets/models/model-5600-highpoly/mesh.json'
