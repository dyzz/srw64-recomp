...
def main() -> int:
    parser = argparse.ArgumentParser(prog="ares_w1_runner.py")
    parser.add_argument("command", choices=("start", "status", "stop"))
    parser.add_argument("--rom", type=Path, default=Path("build/w1/srw64-w1.zh-test.z64"))
    parser.add_argument("--runtime-dir", type=Path, default=Path("build/w1/runtime"))
