...
2026-09-10 的第一版将剧情地图上的黄色菱形替换为圆润金色水滴。网格、法线和材质由宿主 GPU 渲染，原游戏继续提供位置、旋转、相机和剧情时序。使用原始日版 ROM，原有的 96 面 ROM 资源实验仍单独保留。
...
本地资源页的 5600 支持原版 8 面、96 面试作、原生水滴 3,968 面三个选项。页面使用同一份几何和连续法线，金色材质为网页近似；游戏中的光照以 GPU 对照图为准。
